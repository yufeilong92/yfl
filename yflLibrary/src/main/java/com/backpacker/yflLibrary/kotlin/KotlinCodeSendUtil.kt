 ...
 * @Copyright: 2019
 */
class KotlinCodeSendUtil {
    var recLen = 60
    private var mContext: Context? = null
    var handler = Handler()
    private var utilKotlin: KotlinCodeSendUtil? = null
    ...
    fun getInstance(): KotlinCodeSendUtil {
        if (utilKotlin == null)
            utilKotlin = KotlinCodeSendUtil()
        return utilKotlin as KotlinCodeSendUtil
    }
