...
public class SwipePanel extends FrameLayout {
    ...
    //是否结束动画
    private Boolean mIsFinishAnim = false;
    ...
    /**
     *
     * @param isFinishAnim 是否结束动画
     * @param listener 结束动画监听
     */
    public void setOnFullSwipeListener(Boolean isFinishAnim, OnFullSwipeListener listener) {
        mListener = listener;
        mIsFinishAnim = isFinishAnim;
    }
