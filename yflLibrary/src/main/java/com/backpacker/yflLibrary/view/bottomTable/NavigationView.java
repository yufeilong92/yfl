package com.backpacker.yflLibrary.view.bottomTable;
...
public class NavigationView extends FrameLayout {
    ...
    private void addChildView(Model item, final int index) {
        ...
        itemView.setCheck(item.getSelect());
    ...
    public static class Model {
        ...
        //选中图标
        private int activeIcon = R.mipmap.ic_gm_select_s;
        //不选中图标
        private int unactiveIcon = R.mipmap.ic_gm_select_s;
