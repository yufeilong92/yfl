...
import com.backpacker.yflLibrary.java.tool.IntentUtils;
...
public class JavaAppUtil {
     ...
     * @param filePah 文件路径
     */
    public static void installApp(Context context, String filePah) {
        installApp(context, RxFileTool.getFileByPath(filePah));
    }
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        installApp(activity, RxFileTool.getFileByPath(filePath), requestCode);
    }
