 ...
 * @Purpose :视图动画工具箱，提供简单的控制视图的动画的工具方法
 */
public class JavaViewAnimationUtils {

    /**
     * Don't let anyone instantiate this class.
     */
    private JavaViewAnimationUtils() {
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        if (view.getVisibility() != View.INVISIBLE) {
            ...
            AlphaAnimation hiddenAlphaAnimation = JavaAnimationUtils
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        invisibleViewByAlpha(view,  JavaAnimationUtils.DEFAULT_ANIMATION_DURATION,
    ...
    public static void goneViewByAlpha(final View view,
                                       final boolean isBanClick,  final Animation.AnimationListener animationListener) {
        goneViewByAlpha(view,  JavaAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
    ...
    public static void goneViewByAlpha(final View view,
                                        final Animation.AnimationListener animationListener) {
        goneViewByAlpha(view,  JavaAnimationUtils.DEFAULT_ANIMATION_DURATION, false,
                animationListener);
    }
    ...
    public static void visibleViewByAlpha(final View view, long durationMillis,
        ...
        if (view.getVisibility() != View.VISIBLE) {
            ...
            AlphaAnimation showAlphaAnimation =  JavaAnimationUtils
    ...
    public static void visibleViewByAlpha(final View view,
                                          final boolean isBanClick,  final Animation.AnimationListener animationListener) {
        visibleViewByAlpha(view,  JavaAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
