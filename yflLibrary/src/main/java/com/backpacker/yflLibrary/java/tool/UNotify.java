...
/*    *//**
     ...
     * .show(2);
     */
    public UNotify init(Context mContext,String title, String msg, int icon) {
        createChannel();
        notify = new NotificationCompat.Builder(mContext, CHANNEL_ID)
            .setSmallIcon(icon)
     ...
     * .show(2);
     */
    public UNotify initIntent(Context mContext,String title, String msg, int icon, Class aClass) {
        createChannel();
