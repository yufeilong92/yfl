 ...
 * @Purpose :滑动工具
 */
class RecyclerSccrollrUtil {
  companion object {//被companion object包裹的语句都是private的

          private var singletonInstance: RecyclerSccrollrUtil ?= null

          @Synchronized fun getInstance(): RecyclerSccrollrUtil?{
              if (singletonInstance == null){
                  singletonInstance =  RecyclerSccrollrUtil()
              }
