...
public class LocaUtil {
    ...
    private static volatile LocaUtil _singleton;
    private Context mContext;
    public static LocaUtil get_Instance(Context context) {
        if (_singleton == null) {
            synchronized (LocaUtil.class) {
                if (_singleton == null) {
                    _singleton = new LocaUtil(context);
                }
            }
        }
        return _singleton;
